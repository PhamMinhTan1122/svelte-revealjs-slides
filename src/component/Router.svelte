...
{#if currentRoute=='/'}
  <nav>
    <ul>
      <li>
        <a href="/svelte-revealjs-slides/do_an_mon_tin_1" on:click|preventDefault={() => navigateTo('/do_an_mon_tin_1')}> do_an_mon_tin_1 </a>
        <a href="/svelte-revealjs-slides/more" on:click|preventDefault={() => navigateTo('/more')}> more </a>
      </li>
    </ul>
  </nav>
{/if}
